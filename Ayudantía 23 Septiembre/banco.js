class BankAccount {
    ...
    transferCredit(destinationAccount, amount) {

        if(this.credit<amount){
            console.log(this.fullName+" no tiene suficientes fondos para hacer la transferencia")
        }else{
            this.credit-=amount;
            destinationAccount.credit+=amount;
            console.log(this.fullName+" ha transferido exitosamente " + amount+ " al usuario "+destinationAccount.fullName);
        }
...
const account1 = new BankAccount('1111111-1', 'Caro Da Silva', 1, 'cdasilva@codingdojo.cl',2000);

const account2 = new BankAccount('22222222-2', 'Dani Lorca', 2, 'hola@gmail.com', 2000);

console.log(account1)
console.log(account2)

account1.transferCredit(account2,1000);

console.log(account1)
console.log(account2)

account1.transferCredit(account2,3000);
